  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section className="w-full min-h-[100dvh] flex flex-col pt-24 md:pt-32 pb-0 bg-background overflow-hidden relative">
        <div className="container mx-auto px-4 z-10 w-full flex-1 flex flex-col md:flex-row items-stretch">
          ...
          <div className="w-full md:w-1/2 flex items-center pt-12 md:pt-0 relative z-20">
            <Reveal>
              <div className="max-w-xl">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-8 md:mb-12">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <a
                        ...
                        className="flex flex-1 items-center justify-center gap-3 bg-[#25D366] text-white hover:bg-[#20BE5A] px-6 py-4 rounded-full font-bold text-base transition-transform md:hover:scale-105 active:scale-95 shadow-xl animate-[pulse_2s_infinite]"
                      >
